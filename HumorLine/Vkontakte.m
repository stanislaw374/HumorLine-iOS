...
NSString * const vkAppId = @"2877452";
...
- (void)authenticate
{
    NSString *authLink = [NSString stringWithFormat:@"http://api.vk.com/oauth/authorize?client_id=%@&scope=wall&redirect_uri=http://api.vk.com/blank.html&display=touch&response_type=token", vkAppId];
